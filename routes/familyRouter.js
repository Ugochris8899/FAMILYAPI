...
router.post( '/families', upload.fields( [ { name: "childrenImage", maxCount: 1000000000 } ] ), createFamily )

router.get( '/families', getall );

router.get( '/families/:id', getOne );

router.put( '/families/:id', upload.fields( [ { name: "childrenImage", maxCount: 1000000000 } ] ), updateF );
